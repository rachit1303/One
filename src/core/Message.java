...
public class Message implements Comparable<Message> {
	...
	public int[] SetSourceCode (int[] temp) {
		return this.sourceCode = temp;
	}
	
	public int[] SetEncode (int[] temp) {
		return this.encodeCode = temp;
	}
	
	public int[] SetGMatrix (int[] temp) {
		return this.Gmatrix = temp;
	}
	...
	protected void copyFrom(Message m) {
		...
		this.appID = m.appID;
		this.encodeCode = m.encodeCode;
		this.Gmatrix = m.Gmatrix;
